...
# Establish private services access between project VPC and Google's service VPC
...
# Populate Secret Manager secret versions (secrets created in IAM module)
...
resource "google_secret_manager_secret_version" "db_host" {
  secret      = "projects/${var.project_id}/secrets/${var.project_name}-db-host"
...
resource "google_secret_manager_secret_version" "db_password" {
  secret      = "projects/${var.project_id}/secrets/${var.project_name}-db-password"
  secret_data = random_password.db_password.result
}

resource "google_secret_manager_secret_version" "db_name" {
  secret      = "projects/${var.project_id}/secrets/${var.project_name}-db-name"
  secret_data = google_sql_database.app_db.name
}

resource "google_secret_manager_secret_version" "db_user" {
  secret      = "projects/${var.project_id}/secrets/${var.project_name}-db-user"
